...
export default {
  url: {
    ...
    channel:{
      list:`${urlBase}api/channel`,
      create: `${urlBase}api/channel/create`,
      delete: `${urlBase}api/channel/delete`,
      search: `${urlBase}api/channel/search`,
      update: `${urlBase}apichannel/update`,
      query: `${urlBase}api/channel/{id}`,
    },
