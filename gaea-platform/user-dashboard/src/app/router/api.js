...
module.exports = app => {
  ...
  app.router.get('/v2/blocks/:channel_id/:peerName', app.controller.explorer.getBlock);
  app.router.get('/v2/txrealtime/:channel_id/:peerName/:minutes', app.controller.explorer.getTransactionForRealtime);
